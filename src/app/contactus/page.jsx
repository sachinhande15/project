...
export default function ContactUs() {
  return (
    <>
      <main className="bg-gradient-to-tr from-purple-800 via-green-200 to-red-400 ">
        <Navbar></Navbar>
        <section class="body-font sm:h-screen">
          <div class=" px-5 py-24 mx-auto ">
            <div class="flex flex-col text-center w-full mb-12 ">
              <h1 class="sm:text-3xl text-4xl font-medium title-font mb-4 text-gray-900">
                Contact Us
              </h1>
              <p class="lg:w-2/3 mx-auto leading-relaxed font-bold text-3xl">
              ...
              <div class="flex flex-wrap -m-2">
                <div class="p-2 w-1/2">
                  <div class="relative">
                    <label
                      htmlFor="name"
                      class="leading-7 text-md font-semibold "
                    >
                      Name
                    </label>
                    <input
                      ...
                      id="name"
                      name="name"
                      class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none  py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                </div>
                <div class="p-2 w-1/2">
